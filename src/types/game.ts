...
export interface AnswerRow {
  ...
  /** Блок 4: команда, которой присудили этот ответ (цвет карточки) */
...
export interface GameState {
  ...
  /** Блок 4 (игра наоборот): очки последней открытой карточки — начисляются команде после нажатия кнопки. */
  block4PendingPoints?: number
  /** Блок 4: была нажата кнопка левой команды в этом раунде. */
  block4LeftButtonPressed?: boolean
  /** Блок 4: была нажата кнопка правой команды в этом раунде. */
  block4RightButtonPressed?: boolean
  /** Блок 4: индекс последней открытой карточки (для присвоения команде при нажатии кнопки). */
  block4LastRevealedIndex?: number
}
